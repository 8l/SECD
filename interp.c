...
DEFINE_SYM(ap_sym     ,"AP");
DEFINE_SYM(add_sym    ,"ADD");
DEFINE_SYM(atom_sym   ,"ATOM");
DEFINE_SYM(car_sym    ,"CAR");
DEFINE_SYM(cdr_sym    ,"CDR");
DEFINE_SYM(cons_sym   ,"CONS");
DEFINE_SYM(div_sym    ,"DIV");
DEFINE_SYM(dum_sym    ,"DUM");
DEFINE_SYM(eq_sym     ,"EQ");
DEFINE_SYM(join_sym   ,"JOIN");
DEFINE_SYM(ld_sym     ,"LD");
DEFINE_SYM(ldc_sym    ,"LDC");
DEFINE_SYM(ldf_sym    ,"LDF");
DEFINE_SYM(leq_sym    ,"LEQ");
DEFINE_SYM(mul_sym    ,"MUL");
DEFINE_SYM(print_sym  ,"PRINT");
DEFINE_SYM(rap_sym    ,"RAP");
DEFINE_SYM(read_sym   ,"READ");
DEFINE_SYM(rem_sym    ,"REM");
DEFINE_SYM(rtn_sym    ,"RTN");
DEFINE_SYM(sel_sym    ,"SEL");
DEFINE_SYM(stop_sym   ,"STOP");
DEFINE_SYM(sub_sym    ,"SUB");
